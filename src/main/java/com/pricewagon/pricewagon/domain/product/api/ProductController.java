...
public class ProductController {
	...
	public List<BasicProductInfo> getBasicProductsByCategory(
		...
		return productService.getBasicProductsByCategory(shop, pageable, categoryId);
	}
